...
export default function FormPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <PageHeader title="Nuevo Tasks" subtitle="Completa los datos y guarda." />
      <Card>
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); router.push("/tasks"); }}>
          ...
          <div className="flex gap-2 pt-2">
            ...
            <Button type="button" variant="secondary" onClick={() => router.push("/tasks")}>Cancelar</Button>
          </div>
        </form>
      </Card>
    </div>
